                    ...
                    <div class="content">
                        <div class="post-content">
                                        ...
                                        <div class="">
                                            <div class=" text-center mt-3"> <span class="myratings">4.5</span>
                                                ...
                                                <fieldset class="rating"> <input type="radio" id="star5" name="rating"
                                                        ...
                                                        for="star4half" title="Pretty good - 4.5 stars"></label> <input
                                                    ...
                                                    <input type="radio" id="starhalf" name="rating" value="0.5" /><label
                                                        ...
                                                        title="Sucks big time - 0.5 stars"></label> <input type="radio"
                                                        class="reset-option" name="rating" value="reset" /> </fieldset>
                            ...
                            <div class="post-text text-style fzaWUy">
                                ...
                                <figcaption class="captionClass mt-3" style="text-align: center; color: rgb(153, 153, 153)">
                                ...
                                <figure class="figureClass">
                                    <figcaption class="captionClass" style="text-align: left; color: rgb(153, 153, 153)">
