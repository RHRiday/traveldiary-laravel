...
<div class="container">
    <div class="py-5 text-center">
        ...
        <p class="lead">We have provided this form for EasyCheckout (Popup) Payment integration with SSLCommerz.</p>
    </div>
        ...
        <div class="col-md-4 order-md-2 mb-4">
            ...
            <ul class="list-group mb-3">
                ...
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    ...
                    <small><span class="text-muted">{{ $package->title }}</span></small>
                </li>
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    <div>
                    ...
                    <span class="text-muted">{{ $package->deadline }}</span>
                </li>
